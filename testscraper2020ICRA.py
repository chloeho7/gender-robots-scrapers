...
URL = "https://ieeexplore.ieee.org/xpl/conhome/9187508/proceeding?isnumber=9196508&pageNumber={}"

pagenum = 1
firstpage = rendering(URL.format(pagenum))
...
with open(outfile, 'w') as f:
    ...
    while pagenum<50:
        page = rendering(URL.format(pagenum))
